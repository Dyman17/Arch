...
NEARBY_WORDS = ("рядом", "поблизости", "nearby", "near", "жанында", "маңында", "что посмотреть", "куда сходить")
HELP_WORDS = ("помощь", "умеешь", "help", "көмек", "что ты", "пример")
ROUTE_WORDS = ("как пройти", "где", "покажи", "маршрут", "қайда", "қалай", "where", "how", "route", "museum", "музей")
