...
| Точка стелы | 43.6420, 51.1720 (набережная), heading 90° — сверить на месте |
...
- 12 мест: Актау (3) + Мангистау (9), координаты сверены ресёрчем
- 3 сцены TarihSky: набережная, форт, Шакпак-ата (тексты — заглушки до 0.4)
- Фото мест/сцен — нет, нужны реальные материалы (0.2/0.4)
