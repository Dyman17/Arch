...
| # | Задача | Ветка | Статус |
|---|--------|-------|--------|
| F1 | Карта-витрина: точки без кликов, зум на место по команде диалога | `Dyman17` | ✅ |
| F2 | Диалог UI: приветствие, субтитры, волна/индикатор, переспрос | `Dyman17` | ✅ |
| F3 | Автовключение по dB + запись + отправка voice | `Dyman17` | ✅ |
| F4 | Показ места: зум, маршрут, стрелка `bearing−heading` | `Dyman17` | ✅ |
| F5 | TarihSky: автопоказ + голосовое листание | `Dyman17` | ✅ |
| F6 | QR-экран по команде + таймаут 60 сек | `Dyman17` | ✅ |
| F7 | Сон с часами, языки авто, таймауты, сброс | `Dyman17` | ✅ |
