...
| # | Задача | Ветка | Статус |
|---|--------|-------|--------|
| F1 | Карта-витрина: точки без кликов, зум на место по команде диалога | `feature/ui-core` | ✅ |
| F2 | Диалог UI: приветствие, субтитры, волна/индикатор, переспрос | `feature/ui-core` | ✅ |
| F3 | Автовключение по dB + запись + отправка voice | `feature/ui-core` | ✅ |
| F4 | Показ места: зум, маршрут, стрелка `bearing−heading` | `feature/ui-core` | ✅ |
| F5 | TarihSky: автопоказ + голосовое листание | `feature/ui-core` | ✅ |
| F6 | QR-экран по команде + таймаут 60 сек | `feature/ui-core` | ✅ |
| F7 | Сон с часами, языки авто, таймауты, сброс | `feature/ui-core` | ✅ |
